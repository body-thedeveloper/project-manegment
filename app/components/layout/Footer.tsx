        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <Link href="/projects" className="text-base text-gray-500 hover:text-gray-900 transition-colors">
                  Browse Projects
                </Link>
              </li>
              <li>
                <Link href="/create" className="text-base text-gray-500 hover:text-gray-900 transition-colors">
                  Start a Project
                </Link>
              </li>
              <li>
                <Link href="/contribute" className="text-base text-gray-500 hover:text-gray-900 transition-colors">
                  How to Contribute
                </Link>
              </li>
              <li>
                <Link href="/success-stories" className="text-base text-gray-500 hover:text-gray-900 transition-colors">
                  Success Stories
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link href="/guidelines" className="text-base text-gray-500 hover:text-gray-900 transition-colors">
                  Community Guidelines
                </Link>
              </li>
              <li>
                <Link href="/support" className="text-base text-gray-500 hover:text-gray-900 transition-colors">
                  Support Center
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-200 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0 flex space-x-6">
              <Link href="/privacy" className="text-gray-400 hover:text-gray-500 transition-colors">
                Privacy Policy
              </Link>
              <Link href="/terms" className="text-gray-400 hover:text-gray-500 transition-colors">
                Terms of Service
              </Link>
